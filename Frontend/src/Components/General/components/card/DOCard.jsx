...
//USE STATE IMPORTS
import Modal_donation from '../modal/Modal_donation';
import { useState } from "react"
import { useEffect } from "react";
import axios from 'axios';
export default function DOCard({post, currentUser}) {
  ...
  return (
    ...
    <Modal_donation modal={modal} toggleModal={toggleModal} user={user} post={post}/>
    </CardActionArea>
